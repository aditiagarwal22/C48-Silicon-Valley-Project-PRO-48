class Game {
  ...
  start() {
    ...
    //ACT 1 - ADD MORE OBSTACLES IN RANDOM X AND Y POS
    var obstaclesPositions = [
      { x: width / 2 + 450, y: height - 800, image: obstacle2Image, scale:0.3 },
      { x: width / 2 - 350, y: height - 1300, image: obstacle1Image, scale: 0.02 },
      { x: width / 2 + 450, y: height - 1800, image: obstacle1Image, scale: 0.02},
      { x: width / 2 - 380, y: height - 2300, image: obstacle2Image, scale:0.3},
      { x: width / 2, y: height - 2800, image: obstacle2Image, scale:0.3 },
      { x: width / 2 - 380, y: height - 3300, image: obstacle1Image, scale: 0.02 },
      { x: width / 2 + 380, y: height - 3300, image: obstacle2Image, scale:0.3 },
      { x: width / 2 + 450, y: height - 3800, image: obstacle2Image , scale:0.3},
      { x: width / 2 - 350, y: height - 4300, image: obstacle1Image, scale: 0.02 },
      { x: width / 2 + 250, y: height - 4800, image: obstacle2Image , scale:0.3},
      { x: width / 2, y: height - 5300, image: obstacle1Image, scale: 0.02 },
      { x: width / 2 - 180, y: height - 5500, image: obstacle2Image, scale:0.3 }
    ];

    // Adding fuel sprite in the game
    this.addSprites(fuels, 6, fuelImage, 0.1);
